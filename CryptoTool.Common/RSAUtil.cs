...
namespace CryptoTool.Common
{
    ...
    public class RSAUtil
    {
        ...
        public static void GeneratePfxCertificate(string pfxPath, string password = "123456")
        {
            ...
            var cert = DataCertificate.GenerateSelfSignedCertificate("CN=127.0.0.1", "CN=root ca", caPrivKey);
        ...
        {
            var caPrivKey = DataCertificate.GenerateCACertificate("CN=root ca");
            return DataCertificate.GenerateSelfSignedCertificate("CN=127.0.0.1", "CN=root ca", caPrivKey);
        }
